...
public class ExpressionManipulators {
	...
	//undefined variable
	//Throw EvaluationError if any of the expressions uses an unknown oper
	...
	// It will analysis the node and plot the image using given data, and it 
	...
	// Return true if the given node is an expression. Otherwise false
